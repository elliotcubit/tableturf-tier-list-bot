...
# The path to the JSON sleeve metadata manifest
SLEEVE_MANIFEST_PATH = "sleeve_manifest.json"
...
def main():
    db = DB(SQLITE_FILE, MANIFEST_PATH, MAPIFEST_PATH, SLEEVE_MANIFEST_PATH, GALLERY_PATH)
